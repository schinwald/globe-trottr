...
const continentMap: Record<string, string> = {
  ...
  "NIC": "North America", "KNA": "North America", "LCA": "North America", "VCT": "North America", 
...
export const getNeighborHint = (country: Country, guessedCountries: Country[]): string => {
...
export const getRandomHint = (country: Country, guessedCountries: Country[]): string => {
  const hintFunctions = [
    getFirstLetterHint,
    getContinentHint,
    getLengthHint,
...
export const getHintForRandomCountry = (countries: Country[]): string | null => {
