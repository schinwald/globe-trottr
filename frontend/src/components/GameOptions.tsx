...
const GameOptions: React.FC<GameOptionsProps> = ({
	...
	const handleHintChange = (e: React.ChangeEvent<HTMLSelectElement>) => {
		onOptionsChange({
			...options,
			maxHints: Number.parseInt(e.target.value),
		});
	};
		...
		<div className="bg-white rounded-lg shadow-sm border border-gray-200 p-4">
			<div className="space-y-4">
				...
				<div className="flex items-center">
					...
					<label htmlFor="time-limit" className="mr-2 text-sm font-medium">
						Time Limit:
					</label>
					<select
						id="time-limit"
				...
				<div className="flex items-center">
					...
					<label htmlFor="max-hints" className="mr-2 text-sm font-medium">
						Max Hints:
					</label>
					<select
						id="max-hints"
